...
public class Curr_chart extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        curr_code.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "840 - Доллар США", "978 - Евро", "826 - Фунт" }));
    ...
    private void Calc_range() {                                            
        ...
        int mYear = (int) getObjectFloatNaN(this.minus_year.getValue()) + 1;                
        ...
        for (int i = 0; i <= mYear - 1; i++) {
            ...
            // день
            if (this.check_day.isSelected() == true) {           
                
                int mMonthS = this.month_com.getSelectedIndex() + 1;
                int mDay = (int) getObjectFloatNaN(this.plus_day.getValue()) + (int) getObjectFloatNaN(this.minus_day.getValue()) + 1;                
                ...
                // минус дней
                if ((int) getObjectFloatNaN(this.minus_day.getValue()) > 0) {
                    localDateTime = mDate1[i].toInstant().atZone(ZoneId.systemDefault()).toLocalDateTime();
                    localDateTime = localDateTime.minusDays((int) getObjectFloatNaN(this.minus_day.getValue()));
                    mDate1[i] = Date.from(localDateTime.atZone(ZoneId.systemDefault()).toInstant());                
                }                
            ...
            // месяц
            else if (this.check_month.isSelected() == true) {
                
                int mMonth = (int) getObjectFloatNaN(this.plus_month.getValue()) + (int) getObjectFloatNaN(this.minus_month.getValue()) + 1;                
                int mMonthS = this.month_com.getSelectedIndex() - (int) getObjectFloatNaN(this.minus_month.getValue()) + 1;
                if (mMonthS < 0) {
                    mMonthS = 12 + mMonthS;
                    if (i == 0) { year = year - 1; }
                }
        ...
        String [][] mArray;
        mArray = CurrencyСhart.getKursNbu(mCurrCode, mDate1, mDate2);
